gui_symptoms = ['itching', 'skin rash', 'nodal skin eruptions', 'continuous sneezing',
...
model_symptoms = ['itching', 'skin_rash', 'nodal_skin_eruptions', 'continuous_sneezing',
...
# for (o,n) in zip(symptoms_old,symptoms_new):
#     print(o,n)